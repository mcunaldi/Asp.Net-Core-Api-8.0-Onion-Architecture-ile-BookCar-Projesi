...
public class _DefaultStatisticsComponentPartial : ViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        var responseMessage3 = await client.GetAsync("https://localhost:7038/api/Statistics/GetBrandCount");
        ...
        var responseMessage4 = await client.GetAsync("https://localhost:7038/api/Statistics/GetCarCountByFuelElectric");
